...
plugins=(brew fzf git python z brew zsh-autosuggestions fast-syntax-highlighting zsh-history-substring-search web-search dotenv)
...
## default preview
export FZF_DEFAULT_OPTS='--height=80% --preview="bat --color=always {}" --preview-window=top:40%:wrap'
